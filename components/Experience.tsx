...
export default function Experience() {
  ...
  return (
    <section id="experience" className="min-h-screen flex items-center justify-center bg-slate-900 py-20">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            {experiences.map((exp, index) => (
              <motion.div
                ...
                className="bg-slate-800 rounded-xl p-6 md:p-8 border border-slate-700 hover:border-purple-500 transition-colors duration-300"
              >
